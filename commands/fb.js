...
Command({
    ...
    if (!args[0]) return msg.reply('Please provide an fb url!\eg: !fb https://www.facebook.com/watch?v=123456789');
        await msg.react('⏳');
        const res = await axios.get(`https://diegoson-naxordeve.hf.space/facebook?url=${args[0]}`);
